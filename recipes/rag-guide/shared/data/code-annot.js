  ...
  "what-rag-minimal-rag": {
    ...
    "regions": [
      ...
      },
      {
        ...
        "explain": {
          "ru": "Kazhdyj tekst prevrashchaetsja v vektor fiksirovannoj dliny (dim 1536 dlja text-embedding-3-small). Formy vyzova realnye (OpenAI Embeddings, platform.openai.com/docs/guides/embeddings).",
          "en": "Each text becomes a fixed-length vector (dim 1536 for text-embedding-3-small). The call shapes are real (OpenAI Embeddings, platform.openai.com/docs/guides/embeddings)."
        }
      },
      {
        "id": "wr-query",
      ...
      },
      {
        ...
        "explain": {
          "ru": "Najdennyj chunk podkladyvaetsja v prompt (augmented), i model otvechaet tolko po nemu (generation). Forma vyzova - realnyj Anthropic Messages API (docs.anthropic.com/en/api/messages).",
          "en": "The found chunk is slotted into the prompt (augmented), and the model answers only from it (generation). The call shape is the real Anthropic Messages API (docs.anthropic.com/en/api/messages)."
        }
      }
    ]
  },
  ...
  "production-fastapi-endpoint": {
    ...
    "regions": [
      ...
      },
      {
        ...
        "explain": {
          "ru": "Otdelnaja cena za vhodnye i vyhodnye tokeny; svetit s pricing vendora (naprimer, Anthropic pricing, anthropic.com/pricing). cost_usd skladyvaet oba slagaemyh.",
          "en": "Separate price for input and output tokens; check the vendor pricing (for example Anthropic pricing, anthropic.com/pricing). cost_usd sums both addends."
        }
      },
      {
        "id": "pr-cache-key",

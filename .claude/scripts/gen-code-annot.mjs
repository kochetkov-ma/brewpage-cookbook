...
const BLOCKS = [
  {
    ...
    regions: [
      ...
      { id: "wr-embed", lines: [16, 18], label: { ru: "Funkcija embed", en: "embed function" }, explain: { ru: "Kazhdyj tekst prevrashchaetsja v vektor fiksirovannoj dliny (dim 1536 dlja text-embedding-3-small). Formy vyzova realnye (OpenAI Embeddings, developers.openai.com/api/docs/guides/embeddings).", en: "Each text becomes a fixed-length vector (dim 1536 for text-embedding-3-small). The call shapes are real (OpenAI Embeddings, developers.openai.com/api/docs/guides/embeddings)." } },
  ...
  },
  {
    ...
    regions: [
      ...
      { id: "pr-pricing", lines: [10, 15], label: { ru: "Raschet stoimosti", en: "Cost calculation" }, explain: { ru: "Otdelnaja cena za vhodnye i vyhodnye tokeny; svetit s pricing vendora (naprimer, Anthropic pricing, platform.claude.com/docs/en/about-claude/pricing). cost_usd skladyvaet oba slagaemyh.", en: "Separate price for input and output tokens; check the vendor pricing (for example Anthropic pricing, platform.claude.com/docs/en/about-claude/pricing). cost_usd sums both addends." } },

...
| 9 | This repo has NO root `TODO.md` -- NEVER invent one. Ship-state prose = `.claude/features/STATUS.md` (link it, !=duplicate). Root `features/*.md` = per-recipe content plans, NOT the task board |
